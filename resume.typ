...
#skill("Языки", "JavaScript, TypeScript, HTML5, CSS3 (SASS, LESS, TailwindCSS, UnoCSS), Go, Python, SQL, Typst, LaTeX")
...
#project(
  ...
  [
    ...
    - Добавил Drag-and-Drop функциональность для загрузки и автоматического парсинга резюме из PDF файла
    - Реализовал отзывчивый UX с обработкой долгих ИИ-запросов и отменой устаревших сессий.
    - Интегрировал авторизацию, личный кабинет и систему сохранения истории оценок.
    - Оптимизировал кэширование сетевых запросов через TanStack Query и валидацию форм с помощью Zod
    - Сверстал интерфейс на Mantine с поддержкой динамических тем (светлая/тёмная/системная)
    - Настроил мониторинг производительности и метрик системы через Grafana и Prometheus
  ],
)
...
#project(
  ...
  [
    ...
    - Добавил плавные интерфейсные анимации для улучшения пользовательского опыта (UX)
    - Настроил MDX для создания интерактивной онлайн-документации для приложения
...
#project(
  "BookIT",
  "2025",
  "TypeScript, SolidJS, TailwindCSS, Vite, Valibot, Modular Forms",
  ...
  [
    ...
    - Спроектировал админ-панель для корректирования информации о пользователях и их прав доступа
    - Интегрировал интерактивные аналитические графики и бизнес-статистику коворкинга через Grafana
